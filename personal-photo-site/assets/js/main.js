        ...
        initViewer: function() {
            ...
            _.$thumbnails.children()
                .each(function() {
                    ...
                    // Create elements.
                    s.$slide = $('<div class="slide"><div class="caption"></div><a class="image" ></div></a>');

                    // Image.
                    s.$slideImage = s.$slide.children('.image');
                    // s.$slidehref = s.$slide.children('a.addhref');
